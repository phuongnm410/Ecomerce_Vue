<template>
    <header class="sticky top-0 z-50 transition-all duration-300">   <!-- topfix header and transition smooth -->
        <section :class="['w-full', isScrolled ? 'bg-gray-100/95 backdrop-blur shadow-md py-2' : 'bg-gray-100 py-4']"> <!-- change bg and shadow on scroll -->
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> 
                <div class="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-6">
                    <!-- Logo + Mobile Menu Toggle   -->
                    <div class="flex justify-between items-center w-full md:w-auto">
                        <a href="" class="text-2xl font-bold text-pink-600">Shop Ease</a>
                    ...
                    <form class="w-full md:flex-1 max-ww-sm" role="search" aria-label="Site search">
                        <label class="relative w-full" for="">
                            <input type="text" placeholder="Search....."
                                class="w-full px-3 py-3 text-xs border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500 placeholder:italic">
                    ...
                    <aside class="flex items-center justify-end space-x-4 w-full md:w-auto ">
                        ...
                        <button class="relative p-2 text-gray-700 hover:text-pink-600" aria-label="Account">
                            <Icon icon="mdi:account-outline" class="w-5 h-5"></Icon>
                        </button>
                    </aside>
                </div>
            </div>
